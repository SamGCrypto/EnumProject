...
namespace EmuProject
{
    ...
    class Program
    {
        ...
        //Author: Sam G.
        //Description
        //Date Edited addition.10/29/2020
        //***************************************************************
            ...
            do
            {
                ...
                switch (caseSwitch)
                {
                    ...
                    case "e":
                        ...
                        break;
                    case "f":
                        DisplayProgrammableCommands(myFinch);
                        break;
                    case "quit":
        ...
        private static void DisplayProgrammableCommands(Finch myFinch)
        {
            bool endNow = false;
            DisplayProgrammableMenu();
        }

        private static void DisplayProgrammableMenu()
        {
            DisplayHeader("Command sequence menu.");
            Console.WriteLine("Welcome to the robotic command sequence, here you can select what you want to have the robot do.");
            Console.WriteLine("a.)Enter commands.");
            Console.WriteLine("b.)")
